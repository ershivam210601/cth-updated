            ...
            <div>
                ...
                <div class="col-md-4 col-sm-6 col-xs-12 b_packages">
                    ...
                    <div class="b_pack rows">
                        ...
                        <div class="col-md-8 col-sm-8">
                            <h4><a href="/enquiry">Rio de Janeiro<span class="v_pl_name">(Brazil)</span></a></h4> </div>
                        <!-- TOUR ICONS -->
                ...
                <div class="col-md-4 col-sm-6 col-xs-12 b_packages">
                    ...
                    <div class="b_pack rows">
                        <!-- TOUR TITLE -->
                        <div class="col-md-8 col-sm-8">
                            <h4><a href="/enquiry">Paris<span class="v_pl_name">(England)</span></a></h4> </div>
                        <!-- TOUR ICONS -->
                        <div class="col-md-4 col-sm-4 pack_icon">
                            <ul>
                                <li>
                ...
                <div class="col-md-4 col-sm-6 col-xs-12 b_packages">
                    ...
                    <div class="b_pack rows">
                        <div class="col-md-8 col-sm-8">
                            <h4><a href="/enquiry">South India<span class="v_pl_name">(India)</span></a></h4> </div>
                        <div class="col-md-4 col-sm-4 pack_icon">
                            <ul>
                                <li>
                                    <a href="#"><img src="images/clock.png" alt="Date" title="Tour Timing" /> </a>
                ...
                <div class="col-md-4 col-sm-6 col-xs-12 b_packages">
                    ...
                    <div class="b_pack rows">
                        <div class="col-md-8 col-sm-8">
                            <h4><a href="/enquiry">The Great Wall<span class="v_pl_name">(China)</span></a></h4> </div>
                        <div class="col-md-4 col-sm-4 pack_icon">
                            <ul>
                                <li>
                                    <a href="#"><img src="images/clock.png" alt="Date" title="Tour Timing" /> </a>
                ...
                <div class="col-md-4 col-sm-6 col-xs-12 b_packages">
                    ...
                    <div class="b_pack rows">
                        <div class="col-md-8 col-sm-8">
                            <h4><a href="/enquiry">Nail Island<span class="v_pl_name">(Andaman)</span></a></h4> </div>
                        <div class="col-md-4 col-sm-4 pack_icon">
                            <ul>
                                <li>
                                    <a href="#"><img src="images/clock.png" alt="Date" title="Tour Timing" /> </a>
                ...
                <div class="col-md-4 col-sm-6 col-xs-12 b_packages">
                    ...
                    <div class="b_pack rows">
                        <div class="col-md-8 col-sm-8">
                            <h4><a href="/enquiry">Mauritius<span class="v_pl_name">(Indiana)</span></a></h4> </div>
                        <div class="col-md-4 col-sm-4 pack_icon">
                            <ul>
                                <li>
                                    <a href="#"><img src="images/clock.png" alt="Date" title="Tour Timing" /> </a>
