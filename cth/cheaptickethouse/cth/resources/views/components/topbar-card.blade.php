            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="ed-com-t1-left">
                        <ul>
                            <li><a href="#">Lake Road, Suite 180 Farmington Hills, U.S.A.</a>
                            </li>
                            <li><a href="#">1800 xxxx xxx</a>
                            </li>
                        </ul>
                    </div>
                                    ...
                                    <div class="about-mm m-menu">
                                        <div class="m-menu-inn">
                                            ...
                                            <div class="mm1-com mm1-s2">
                                                ...
                                                <a href="/enquiry" class="mm-r-m-btn">Read more</a>
                                            </div>
                                            <div class="mm1-com mm1-s3">
                                                <ul>
                                                    <li><a href="/enquiry">All Booking</a></li>
                                                    <li><a href="/enquiry">Tour Package Booking</a></li>
                                                    <li><a href="/enquiry">Hotel Booking</a></li>
                                                    <li><a href="/enquiry">Car Rentals Booking</a></li>
                                                    <li><a href="/enquiry">Flight Booking</a></li>
                                                    <li><a href="/enquiry">Slider Booking</a></li>
                                                </ul>
                                            </div>
                                            <div class="mm1-com mm1-s4">
                                                <ul>
                                                    <li><a href="/enquiry">All Package</a></li><li><a href="family-package.html">Family Package</a></li>
                                                    <li><a href="/enquiry">Honeymoon Package</a></li>
                                                    <li><a href="/enquiry">Group Package</a></li>
                                                    <li><a href="/enquiry">WeekEnd Package</a></li>
                                                    <li><a href="/enquiry">Regular Package</a></li>
                                                    <li><a href="/enquiry">Custom Package</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="admi-mm m-menu">
                                        <div class="m-menu-inn">
                                            <div class="mm2-com mm1-com mm1-s1">
                                                <div class="ed-course-in">
                                                    <a class="course-overlay" href="/enquiry">
                                            ...
                                            <div class="mm2-com mm1-com mm1-s1">
                                                <div class="ed-course-in">
                                                    <a class="course-overlay" href="/enquiryl">
        ...
        <div class="inn">
            ...
            <div class="late-news">
                ...
                <ul>
                    ...
                    <li>
                        <div class="rel-pro-img">
                            <img src="images/rooms/02.jpeg" alt="" loading="lazy">
                        </div>
                        <div class="rel-pro-con">
                            <h5>Long established fact that a reader distracted</h5>
                            <span class="ic-date">12 Dec 2023</span>
                    ...
                    <li>
                        <div class="rel-pro-img">
                            <img src="images/rooms/04.jpeg" alt="" loading="lazy">
                        </div>
                        <div class="rel-pro-con">
                            <h5>Long established fact that a reader distracted</h5>
                            <span class="ic-date">12 Dec 2023</span>
                    ...
                    <li>
                        <div class="rel-pro-img">
                            <img src="images/rooms/05.jpeg" alt="" loading="lazy">
                        </div>
                        <div class="rel-pro-con">
                            <h5>Long established fact that a reader distracted</h5>
                            <span class="ic-date">12 Dec 2023</span>
